...
import static org.openhab.binding.diyonxbee.internal.DiyOnXBeeBindingConstants.CHANNEL_1;
...
/**
 * The {@link DiyOnXBeeHandler} is responsible for handling commands, which are
 * sent to one of the channels.
 *
 * @author Jürgen Richtsfeld - Initial contribution
 */
@NonNullByDefault
public class DiyOnXBeeHandler extends BaseThingHandler {
    ...
    public void initialize() {
        ...
        config = getConfigAs(DiyOnXBeeConfiguration.class);
